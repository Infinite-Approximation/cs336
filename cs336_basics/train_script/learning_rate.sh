...
# Learning rates to try (including 3e-3)
LEARNING_RATES=(1e-4 3e-4 1e-3 3e-3 1e-2 1e-1)
...
for LR in "${LEARNING_RATES[@]}"; do
    ...
    CHECKPOINT_DIR="checkpoints/tinystories_17m_lr_${LR}"
    mkdir -p $CHECKPOINT_DIR
    
    # Set WandB run name
    WANDB_RUN_NAME="tinystories_17m_lr_${LR}"
